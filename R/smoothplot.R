...
#' @export
smoothplot <- function(portefe="AC.PA ACA.PA",portefeang="OML.L", nomb="75 25", ticker = "GOOG", from = "2013-01-01", to=Sys.time()){
...
getPortefeuilleValue(portefe, portefeang, nomb, from, to);}
